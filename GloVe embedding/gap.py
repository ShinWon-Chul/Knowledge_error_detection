...
def gap_statistic(X, refs=None, B=10, K=range(1,41), N_init = 10):
    '''
    ...
    for indk, k in enumerate(K):
        ...
        k_means =  Kmeans(n_clusters=k, init='k-means++', n_init=N_init, max_iter=150, tol=0.0001, verbose=0, random_state=None, copy_x=True)
        k_means.fit(X)
